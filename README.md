...
pip install flask
```
3. Run the app.py file, it should give you a URL
4. Open a web browser and go to the given URL (http://127.0.0.1:5000)
5. The page should display the message “Cedrick Balagtas Hello World”
